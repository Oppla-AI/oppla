...
pub fn app_menus() -> Vec<Menu> {
    use oppla_actions::Quit;

    vec![
        Menu {
            name: "Oppla".into(),
            items: vec![
                MenuItem::action("About Oppla…", oppla_actions::About),
                ...
                MenuItem::submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            ...
                            oppla_actions::OpenDefaultKeymap,
                        ),
                        MenuItem::action("Open Project Settings", super::OpenProjectSettings),
                        MenuItem::action(
                            "Select Theme...",
                            oppla_actions::theme_selector::Toggle::default(),
                        ),
                    ],
                }),
                MenuItem::separator(),
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", oppla_actions::Extensions::default()),
                MenuItem::action("Install CLI", install_cli::Install),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Oppla", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Oppla", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Zoom In",
                    oppla_actions::IncreaseBufferFontSize { persist: false },
                ),
                MenuItem::action(
                    "Zoom Out",
                    oppla_actions::DecreaseBufferFontSize { persist: false },
                ),
                MenuItem::action(
                    "Reset Zoom",
                    oppla_actions::ResetBufferFontSize { persist: false },
                ),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Command Palette...", oppla_actions::command_palette::Toggle),
                MenuItem::separator(),
                MenuItem::action("Go to File...", workspace::ToggleFileFinder::default()),
                // MenuItem::action("Go to Symbol in Project", project_symbols::Toggle),
                MenuItem::action(
                    "Go to Symbol in Editor...",
                    oppla_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    oppla_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::oppla::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", oppla_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", oppla_actions::OpenTelemetryLog),
                MenuItem::action("View Dependency Licenses", oppla_actions::OpenLicenses),
                MenuItem::action("Show Welcome", workspace::Welcome),
                MenuItem::action("Give Feedback...", oppla_actions::feedback::GiveFeedback),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
