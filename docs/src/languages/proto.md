...
Proto/proto3 (Protocol Buffers definition language) support is available through the [Proto extension](https://github.com/Oppla-AI/oppla/tree/main/extensions/proto).
...
Or you can have zed directly invoke `clang-format` by specifying it as a [formatter](https://oppla.ai/docs/configuring-zed#formatter) in your settings:
