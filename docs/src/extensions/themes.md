...
Each theme file should adhere to the JSON schema specified at [`https://oppla.ai/schema/themes/v0.2.0.json`](https://oppla.ai/schema/themes/v0.2.0.json).

See [this blog post](https://oppla.ai/blog/user-themes-now-in-preview) for more details about creating themes.

## Theme JSON Structure

The structure of a Zed theme is defined in the [Zed Theme JSON Schema](https://oppla.ai/schema/themes/v0.2.0.json).
...
We recommend looking at our [existing themes](https://github.com/Oppla-AI/oppla/tree/main/assets/themes) to get a more comprehensive idea of what can be styled.
