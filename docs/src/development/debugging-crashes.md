...
If you have enabled Zed's telemetry these will be uploaded to us when you restart the app. They end up in a [Slack channel (internal only)](https://Oppla-AI.slack.com/archives/C04S6T1T7TQ).
