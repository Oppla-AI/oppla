...
![Asking a question](https://oppla.ai/img/assistant/ask-a-question.png)
...
![Quoting a selection](https://oppla.ai/img/assistant/quoting-a-selection.png)
...
![Receiving an answer](https://oppla.ai/img/assistant/receiving-an-answer.png)
...
1. [`content_prompt.hbs`](https://github.com/Oppla-AI/oppla/tree/main/assets/prompts/content_prompt.hbs): Used for generating content in the editor.

2. [`terminal_assistant_prompt.hbs`](https://github.com/Oppla-AI/oppla/tree/main/assets/prompts/terminal_assistant_prompt.hbs): Used for the terminal assistant feature.
...
Consult Zed's [assets/prompts](https://github.com/Oppla-AI/oppla/tree/main/assets/prompts) directory for current versions you can play with.
...
![Viewing assistant history](https://oppla.ai/img/assistant/assistant-history.png)
