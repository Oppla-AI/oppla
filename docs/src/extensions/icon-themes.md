...
Each icon theme file should adhere to the JSON schema specified at [`https://oppla.ai/schema/icon_themes/v0.2.0.json`](https://oppla.ai/schema/icon_themes/v0.2.0.json).

Here is an example of the structure of an icon theme:

```json
{
  "$schema": "https://oppla.ai/schema/icon_themes/v0.2.0.json",
  "name": "My Icon Theme",
  "author": "Your Name",
  "themes": [
    {
