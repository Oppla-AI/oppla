...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Oppla Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Oppla Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Oppla Editor Preview Instance Running",
        ReleaseChannel::Stable => "Oppla Editor Stable Instance Running",
    }
}
