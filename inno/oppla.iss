...
AppPublisher=Oppla Industries
AppPublisherURL=https://www.oppla.dev/
AppSupportURL=https://www.oppla.dev/
AppUpdatesURL=https://www.oppla.dev/
...
[Files]
Source: "{#ResourcesDir}\Oppla.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Classes\oppla\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Oppla.exe,1"
Root: HKCU; Subkey: "Software\Classes\oppla\shell\open\command"; ValueType: "string"; ValueData: """{app}\Oppla.exe"" ""%1"""
