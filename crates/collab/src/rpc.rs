...
fn model_requests_limit(
    plan: oppla_llm_client::Plan,
    feature_flags: &Vec<String>,
) -> oppla_llm_client::UsageLimit {
    match plan.model_requests_limit() {
        oppla_llm_client::UsageLimit::Limited(limit) => {
            let limit = if plan == oppla_llm_client::Plan::ZedProTrial
                && feature_flags
                    .iter()
        ...
        oppla_llm_client::UsageLimit::Unlimited => oppla_llm_client::UsageLimit::Unlimited,
    }
}
...
fn subscription_usage_to_proto(
    ...
    let plan = match plan {
        proto::Plan::Free => oppla_llm_client::Plan::ZedFree,
        proto::Plan::ZedPro => oppla_llm_client::Plan::ZedPro,
        proto::Plan::ZedProTrial => oppla_llm_client::Plan::ZedProTrial,
    };
