...
For invoice-based billing, a Business plan is required. Contact sales@oppla.ai for more information.

## Settings {#settings}

You can access billing settings at [oppla.ai/account](https://oppla.ai/account).
...
You can access your invoice history by navigating to [oppla.ai/account](https://oppla.ai/account) and clicking "Manage" on your subscription.
...
If you have a VAT/GST ID, you can add it at [oppla.ai/account](https://oppla.ai/account) by clicking "Manage" on your subscription. Check the box that denotes you as a business.
...
Questions or issues can be directed to billing-support@oppla.ai.
