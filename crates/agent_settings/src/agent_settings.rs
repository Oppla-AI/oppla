...
impl From<CompletionMode> for oppla_llm_client::CompletionMode {
    fn from(value: CompletionMode) -> Self {
        match value {
            CompletionMode::Normal => oppla_llm_client::CompletionMode::Normal,
            CompletionMode::Burn => oppla_llm_client::CompletionMode::Max,
        }
    }
}
