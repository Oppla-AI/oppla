...
To see a working example of an extension that provides slash commands, check out the [`slash-commands-example` extension](https://github.com/Oppla-AI/oppla/tree/main/extensions/slash-commands-example).
